...
export const AutoLogout: React.FC = () => {
 ...
 <h3 className="text-xl font-black text-[var(--text-primary)] uppercase mb-2">Sesi Akan Berakhir</h3>
 <p className="text-sm text-[var(--text-secondary)] dark:text-[var(--text-secondary)] dark:text-[var(--text-secondary)] mb-6">
 ...
 <button
 onClick={resetTimer}
 className="w-full bg-white dark:bg-red-950 hover:bg-[var(--bg-secondary)] dark:bg-[var(--bg-secondary)] dark:hover:bg-slate-200 text-white dark:text-[var(--text-primary)] py-3 rounded-xl font-bold uppercase tracking-wider transition-colors"
 >
 Tetap Login
 </button>
 </div>
