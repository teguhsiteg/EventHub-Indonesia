...
export const ChatWidget: React.FC = () => {
 ...
 {/* Chat panel */}
 {open && (
 <div className="fixed bottom-24 right-6 z-50 w-[360px] max-w-[calc(100vw-2rem)] h-[480px] max-h-[calc(100vh-8rem)] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-[var(--glass-border)] dark:border-gray-700 flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200">
 {/* Header */}
 ...
 : 'bg-white dark:bg-gray-800 text-slate-700 border border-[var(--glass-border)] dark:border-gray-700 rounded-bl-md'
 }`}>
 {m.text}
 </div>
 </div>
 ...
 <div className="px-4 py-2.5 rounded-2xl rounded-bl-md bg-white dark:bg-gray-800 border border-[var(--glass-border)] dark:border-gray-700">
 ...
 className="flex items-center gap-2 px-4 py-3 border-t border-[var(--glass-border)] dark:border-gray-700 bg-white dark:bg-gray-900 shrink-0"
 >
 <input
 ref={inputRef}
 type="text"
 ...
 className="flex-1 bg-[var(--bg-secondary)] dark:bg-gray-800 border-none rounded-xl px-4 py-2.5 text-sm outline-none text-[var(--text-primary)] placeholder-slate-400"
 />
 <button
 type="submit"
