...
export const ETicketTemplate: React.FC<ETicketTemplateProps> = ({ participant, event, category }) => {
 ...
 return (
 <div className="w-[400px] bg-white rounded-3xl overflow-hidden shadow-2xl relative font-sans text-[var(--text-primary)] border border-[var(--glass-border)]" id="eticket-content">
 {/* Top Banner */}
 ...
 <div className="absolute -top-4 -left-4 w-8 h-8 bg-[var(--bg-secondary)] rounded-full border-r border-b border-[var(--glass-border)]" />
 <div className="absolute -top-4 -right-4 w-8 h-8 bg-[var(--bg-secondary)] rounded-full border-l border-b border-[var(--glass-border)]" />
 
 {/* Participant Name & BIB */}
 <div className="text-center mb-6">
 <p className="text-xs text-[var(--text-secondary)] font-bold uppercase tracking-wider mb-1">NAMA PESERTA</p>
 <h2 className="text-2xl font-black text-[var(--text-primary)] uppercase leading-none">{participant.fullName}</h2>
 ...
 <hr className="border-dashed border-[var(--glass-border)] my-4" />
 ...
 <p className="font-bold text-[var(--text-primary)]">{category?.name || 'UMUM'}</p>
 </div>
 ...
 <p className="font-bold text-[var(--text-primary)]">{participant.jerseySize}</p>
 </div>
 ...
 <p className="font-bold text-[var(--text-primary)]">{formatDate(event.startDate)}</p>
 </div>
 ...
 <p className="font-bold text-[var(--text-primary)] leading-tight">{event.location}</p>
 </div>
 </div>

 <hr className="border-dashed border-[var(--glass-border)] my-5" />

 {/* QR Code Section */}
 <div className="flex flex-col items-center">
 <p className="text-[10px] text-[var(--text-secondary)] font-bold uppercase tracking-widest mb-3 text-center">Tunjukkan QR untuk Race Pack</p>
 
 <div className="p-3 bg-white rounded-2xl border border-[var(--glass-border)] relative inline-block shadow-sm">
