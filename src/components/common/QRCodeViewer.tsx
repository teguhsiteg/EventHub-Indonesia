...
export const QRCodeViewer: React.FC<QRCodeViewerProps> = ({ 
 ...
 return (
 <div className="flex flex-col items-center p-6 bg-white dark:bg-red-950/80 backdrop-blur-xl border border-[var(--glass-border)] rounded-2xl shadow-2xl shadow-black/40 max-w-sm mx-auto text-center">
 ...
 <div className="p-4 bg-white rounded-2xl border border-[var(--glass-border)] relative inline-block shadow-inner overflow-hidden">
 ...
 {/* Token Display */}
 <div className="mt-3 text-[10px] font-mono text-[var(--text-secondary)] bg-slate-50 dark:bg-red-950/80 px-4 py-2 rounded-lg border border-[var(--glass-border)] break-all max-w-full">
 <span className="text-slate-600">Token: </span>
 <span className="text-slate-600 dark:text-[var(--text-secondary)] dark:text-[var(--text-secondary)]">{value}</span>
 </div>
 </div>
 );
};
