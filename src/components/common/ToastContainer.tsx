...
export const ToastContainer: React.FC = () => {
 ...
 <h5 className="text-xs font-bold text-[var(--text-primary)] dark:text-[var(--text-primary)] uppercase tracking-wider">{n.title}</h5>
 <p className="text-xs text-slate-600 dark:text-slate-600 mt-0.5 leading-relaxed">{n.message}</p>
 </div>
 <button
