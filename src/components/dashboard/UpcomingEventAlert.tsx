      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        ...
        <div className="space-y-3 flex-1">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-slate-50 dark:bg-blue-950/90 border border-amber-500/40 text-amber-300 font-extrabold text-xs">
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col gap-2.5 w-full lg:w-auto shrink-0">
          ...
          {!hasCompletedMedical && onOpenMedical && (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-white dark:bg-blue-950/90 hover:bg-slate-100 dark:bg-slate-800 border border-amber-500/50 text-amber-300 font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2"
            >
