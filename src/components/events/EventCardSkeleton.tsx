...
export const EventCardSkeleton: React.FC = () => {
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden flex flex-col animate-pulse shadow-lg">
      {/* Banner Skeleton */}
      <div className="relative h-48 bg-slate-950 flex items-center justify-center">
        <div className="w-12 h-12 rounded-full bg-slate-900/80 border border-slate-800/60" />
        <div className="absolute top-3 left-3 w-16 h-5 rounded bg-slate-800/90" />
        <div className="absolute top-3 right-3 w-20 h-5 rounded bg-slate-800/90" />
      </div>
      ...
      <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
        <div className="space-y-3">
          ...
          {/* Title line */}
          <div className="w-3/4 h-6 rounded-md bg-slate-800" />

          {/* Description lines */}
          <div className="space-y-1.5 pt-1">
            <div className="w-full h-3 rounded bg-slate-800/70" />
            <div className="w-5/6 h-3 rounded bg-slate-800/70" />
          </div>
