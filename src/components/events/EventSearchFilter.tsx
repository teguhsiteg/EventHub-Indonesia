...
export const EventSearchFilter: React.FC<EventSearchFilterProps> = ({
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-6 shadow-xl mb-8 space-y-5">
        ...
        <div className="lg:col-span-5 relative">
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-10 pr-9 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-orange-500 transition-colors"
            />
            {query && (
              <button
                type="button"
                onClick={() => setQuery('')}
                className="absolute right-3 p-1 text-slate-500 hover:text-slate-300 rounded-full transition-colors"
              >
        ...
        <div className="lg:col-span-3 relative">
          ...
          <div className="relative flex items-center">
            ...
            <select
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-10 pr-8 py-2.5 text-xs text-white focus:outline-none focus:border-orange-500 appearance-none cursor-pointer transition-colors"
            >
        ...
        <div className="lg:col-span-4 relative">
          ...
          <div className="relative flex items-center">
            ...
            <select
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-10 pr-8 py-2.5 text-xs text-slate-200 focus:outline-none focus:border-orange-500 appearance-none cursor-pointer transition-colors"
            >
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          {hasActiveFilters && (
            <button
              type="button"
              onClick={handleReset}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-400 hover:text-slate-200 text-xs font-bold transition-all"
            >
          ...
          {typeof totalResults === 'number' && !isDebouncing && !isSearching && (
            <div className="text-[11px] text-slate-400 font-semibold bg-slate-950 px-3 py-1.5 rounded-lg border border-slate-800">
              <span className="text-white font-extrabold">{totalResults}</span> event ditemukan
            </div>
          )}
        </div>
      </div>
