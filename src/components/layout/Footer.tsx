...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-50 dark:bg-slate-950 border-t border-slate-900 text-slate-500 dark:text-slate-400 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4 md:col-span-2">
            <Link to="/" className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xl font-black text-slate-900 dark:text-white tracking-wider uppercase">
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-white dark:bg-slate-900 hover:bg-slate-100 dark:bg-slate-800 text-xs font-bold text-orange-400 border border-slate-200 dark:border-slate-800 transition-colors"
              >
          ...
          {/* Nav Links */}
          <div>
            <h4 className="text-slate-900 dark:text-white font-bold text-sm uppercase tracking-wider mb-4">Navigasi Utama</h4>
          ...
          {/* Ecosystem Links */}
          <div>
            <h4 className="text-slate-900 dark:text-white font-bold text-sm uppercase tracking-wider mb-4">Guwigo Ecosystem</h4>
            <ul className="space-y-2.5 text-xs font-medium">
              <li>
        ...
        {/* Bottom bar */}
        <div className="pt-8 border-t border-slate-900 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 dark:text-slate-400 gap-4">
          <p>© {currentYear} PT Guwigo Teknologi Indonesia. All rights reserved. Part of Guwigo Ecosystem.</p>
          <div className="flex items-center gap-6">
            <Link to="/about" className="hover:text-slate-600 dark:text-slate-300">Tentang Guwigo</Link>
            <Link to="/faq" className="hover:text-slate-600 dark:text-slate-300">Bantuan & FAQ</Link>
          </div>
        </div>
