...
export const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ 
 ...
 <div className="w-14 h-14 rounded-full border-2 border-[var(--glass-border)] dark:border-white/[0.06]" />
 ...
 <p className="text-slate-600 dark:text-[var(--text-secondary)] dark:text-[var(--text-secondary)] text-sm font-medium animate-pulse">
