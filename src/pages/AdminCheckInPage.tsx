    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 py-12">
      <div className="max-w-xl mx-auto px-4 space-y-8">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl text-center space-y-6">
          ...
          <div>
            <h1 className="text-2xl font-black text-white uppercase">QR Check-In Scanner</h1>
            <p className="text-xs text-slate-400 mt-1">Pemindaian token QR Code peserta untuk pengambilan Race Pack & BIB.</p>
          </div>
          ...
          <form onSubmit={handleScanCheckIn} className="space-y-3 text-xs">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-10 pr-4 py-3 text-white font-mono text-xs focus:border-orange-500"
              />
            </div>
            <button
              type="submit"
          ...
          {participant && (
            <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 text-left space-y-3 text-xs">
              <h4 className="font-bold text-white uppercase border-b border-slate-800 pb-2">Detail Data Peserta</h4>
