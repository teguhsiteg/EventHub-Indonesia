...
export const AdminCheckInPage: React.FC = () => {
 ...
 <div className="bg-white dark:bg-red-950 border border-[var(--glass-border)] rounded-3xl p-6 lg:p-8 shadow-2xl text-center space-y-6">
 ...
 <div>
 <h1 className="text-2xl font-black text-[var(--text-primary)] uppercase">QR Check-In Scanner</h1>
 <p className="text-xs text-[var(--text-secondary)] dark:text-[var(--text-secondary)] dark:text-[var(--text-secondary)] mt-1">Pemindaian token QR Code peserta untuk pengambilan Race Pack & BIB.</p>
 </div>

 {!isCameraActive ? (
 <button
 onClick={requestCameraPermission}
 className="w-full py-4 rounded-2xl bg-[var(--bg-secondary)] dark:bg-[var(--bg-secondary)] hover:bg-slate-200 dark:bg-slate-700 text-[var(--text-primary)] font-bold uppercase tracking-wider flex items-center justify-center gap-3 transition-colors border-2 border-dashed border-[var(--glass-border)] dark:border-slate-600"
 >
 ...
 <div className="h-px bg-slate-200 dark:bg-[var(--bg-secondary)] flex-1"></div>
 ATAU MANUAL
 <div className="h-px bg-slate-200 dark:bg-[var(--bg-secondary)] flex-1"></div>
 </div>
 ...
 className="w-full border border-[var(--glass-border)] rounded-xl pl-10 pr-4 py-3 text-[var(--text-primary)] font-mono text-xs focus:border-red-500"
 />
 </div>
 <button
 type="submit"
 ...
 {participant && (
 <div className=" p-6 rounded-2xl border border-[var(--glass-border)] text-left space-y-3 text-xs">
 <h4 className="font-bold text-[var(--text-primary)] uppercase border-b border-[var(--glass-border)] pb-2">Detail Data Peserta</h4>
 <div className="grid grid-cols-2 gap-2">
 <div>
 <span className="text-[var(--text-secondary)] block text-[10px] uppercase">Nama:</span>
 <span className="font-bold text-[var(--text-primary)] ">{participant.fullName}</span>
 </div>
 <div>
 <span className="text-[var(--text-secondary)] block text-[10px] uppercase">Nomor BIB:</span>
 <span className="font-mono font-black text-yellow-400 text-sm">{participant.bibNumber}</span>
 </div>
 <div>
 <span className="text-[var(--text-secondary)] block text-[10px] uppercase">Ukuran Jersey:</span>
 <span className="font-bold text-[var(--text-primary)] ">{participant.jerseySize}</span>
 </div>
 <div>
 <span className="text-[var(--text-secondary)] block text-[10px] uppercase">Waktu Check-In:</span>
 ...
 <div className="bg-white dark:bg-red-950 border border-[var(--glass-border)] rounded-3xl p-6 lg:p-8 shadow-2xl">
 ...
 <div>
 <h2 className="text-lg font-black text-[var(--text-primary)] uppercase">Riwayat Check-In</h2>
 <p className="text-[11px] text-[var(--text-secondary)] dark:text-[var(--text-secondary)]">20 Data Peserta Terakhir</p>
 </div>
 </div>
 <div className="px-3 py-1 bg-[var(--bg-secondary)] dark:bg-[var(--bg-secondary)] text-[10px] font-bold text-[var(--text-secondary)] dark:text-[var(--text-secondary)] rounded-full border border-[var(--glass-border)] ">
 ...
 <thead className="text-[10px] font-bold text-[var(--text-secondary)] dark:text-[var(--text-secondary)] uppercase tracking-wider bg-slate-50 dark:bg-[var(--bg-secondary)]/50">
 <tr>
 ...
 {historyLoading ? (
 <tr>
 <td colSpan={5} className="py-8 text-center text-[var(--text-secondary)] text-xs">Memuat data riwayat...</td>
 </tr>
 ) : scanHistory.length === 0 ? (
 <tr>
 <td colSpan={5} className="py-8 text-center text-[var(--text-secondary)] text-xs">Belum ada riwayat check-in</td>
 </tr>
 ) : (
 scanHistory.map((hist) => (
 <tr key={hist.id} className="hover:bg-[var(--bg-primary)] dark:hover:bg-[var(--bg-secondary)]/30 transition-colors">
 <td className="px-4 py-3 font-mono text-[11px] text-slate-600 dark:text-[var(--text-secondary)] whitespace-nowrap">
 ...
 <td className="px-4 py-3 text-slate-600 dark:text-[var(--text-secondary)] whitespace-nowrap">
 {hist.jerseySize}
 </td>
