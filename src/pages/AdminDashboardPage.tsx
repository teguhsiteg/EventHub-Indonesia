...
export const AdminDashboardPage: React.FC = () => {
 ...
 <div
 key={i}
 className={`relative overflow-hidden bg-white backdrop-blur-xl border border-[var(--glass-border)] ${card.accent} border-l-[3px] rounded-2xl p-5 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-0.5 group`}
 >
 <div
 ...
 <span
 className={`block font-black mt-1.5 ${card.isCurrency ? "text-xl" : "text-3xl"} text-[var(--text-primary)] `}
 >
 {card.value}
 </span>
 </div>
 ...
 <Link
 to="/admin/check-in"
 className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[var(--bg-secondary)] hover:bg-slate-200 text-white font-bold text-xs uppercase tracking-wider border border-[var(--glass-border)] transition-all"
 >
 ...
 {/* Audit Logs Table */}
 <div className="bg-white backdrop-blur-xl border border-[var(--glass-border)] rounded-2xl overflow-hidden shadow-xl">
 ...
 <thead>
 <tr className="border-b border-[var(--glass-border)] text-[10px] text-[var(--text-secondary)] font-bold uppercase tracking-wider">
 ...
 >
 <td className="py-3 px-6 text-xs text-[var(--text-secondary)] font-mono">
 ...
 {/* Search & Filter Bar */}
 <div className="px-6 py-3 border-b border-[var(--glass-border)] flex flex-wrap gap-3 items-center">
 <input
 type="text"
 placeholder="Cari nama event atau lokasi..."
 value={eventSearch}
 onChange={(e) => setEventSearch(e.target.value)}
 className="flex-1 min-w-[180px] bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-xl px-4 py-2 text-xs text-[var(--text-primary)] focus:border-red-500/50 outline-none placeholder:text-slate-600"
 />
 <select
 value={eventStatusFilter}
 onChange={(e) => setEventStatusFilter(e.target.value)}
 className="bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-xl px-3 py-2 text-xs text-slate-700 focus:border-red-500/50 outline-none"
 >
 ...
 <div className="animate-in fade-in duration-300">
 <div className="bg-white backdrop-blur-xl border border-[var(--glass-border)] rounded-2xl overflow-hidden shadow-xl">
 <div className="px-6 py-4 border-b border-[var(--glass-border)] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
 <div className="flex items-center gap-3">
 ...
 className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--bg-secondary)] hover:bg-slate-200 :bg-slate-700 text-xs font-bold transition-colors"
 >
 ...
 className="hover:bg-white/[0.02] transition-colors"
 >
 <td className="py-4 px-6 text-xs text-[var(--text-secondary)] font-medium">
 {index + 1}
 </td>
 <td className="py-4 px-6">
 {(() => {
 ...
 className="px-2.5 py-1.5 rounded-xl bg-[var(--bg-secondary)] hover:bg-red-500/10 :bg-red-500/20 text-[var(--text-secondary)] hover:text-red-500 transition-colors"
 ...
 className="px-2.5 py-1.5 rounded-xl bg-[var(--bg-secondary)] hover:bg-orange-500/10 :bg-orange-500/20 text-[var(--text-secondary)] hover:text-orange-500 transition-colors"
 ...
 {/* Inline Payout Form */}
 {showPayoutForm && (
 <div className="border-b border-[var(--glass-border)] p-6 bg-[var(--bg-secondary)] ">
 <h4 className="text-xs font-black text-[var(--text-primary)] uppercase tracking-wider mb-4">
 ...
 className="w-full bg-white border border-white/[0.08] rounded-xl p-3 text-[var(--text-primary)] text-xs focus:border-red-500/50 outline-none"
 >
 ...
 placeholder="1000000"
 className="w-full bg-white border border-white/[0.08] rounded-xl p-3 text-[var(--text-primary)] text-xs focus:border-red-500/50 outline-none placeholder:text-slate-600"
 />
 </div>
 <div>
 <label className="block text-[10px] font-bold text-slate-600 uppercase tracking-wider mb-1.5">
 ...
 className="w-full bg-white border border-white/[0.08] rounded-xl p-3 text-[var(--text-primary)] text-xs font-mono focus:border-red-500/50 outline-none placeholder:text-slate-600"
 />
 </div>
 ...
 <div className="animate-in fade-in duration-300">
 <div className="bg-white backdrop-blur-xl border border-[var(--glass-border)] rounded-2xl overflow-hidden shadow-xl max-w-xl mx-auto">
 <div className="px-6 py-4 border-b border-[var(--glass-border)] flex items-center gap-3">
 <div className="w-8 h-8 rounded-lg bg-red-500/10 flex items-center justify-center">
 ...
 className="w-full bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-xl p-3 text-[var(--text-primary)] text-xs focus:border-red-500/50 focus:outline-none focus:ring-1 focus:ring-red-500/30 transition-all"
 >
 {events.map((e) => (
 ...
 className="w-full bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-xl p-3 text-[var(--text-primary)] text-xs font-mono focus:border-red-500/50 focus:outline-none focus:ring-1 focus:ring-red-500/30 transition-all placeholder:text-slate-600"
 />
 </div>
 <div>
 <label className="block text-slate-600 font-bold uppercase tracking-wider mb-1.5 text-[10px]">
 ...
 placeholder="Budi Santoso"
 className="w-full bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-xl p-3 text-[var(--text-primary)] text-xs focus:border-red-500/50 focus:outline-none focus:ring-1 focus:ring-red-500/30 transition-all placeholder:text-slate-600"
 />
 </div>
 </div>
 <div className="grid grid-cols-2 gap-3">
 ...
 className="w-full bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-xl p-3 text-[var(--text-primary)] text-xs font-mono focus:border-red-500/50 focus:outline-none focus:ring-1 focus:ring-red-500/30 transition-all"
 />
 </div>
 <div>
 <label className="block text-slate-600 font-bold uppercase tracking-wider mb-1.5 text-[10px]">
 ...
 <div className="mt-8 bg-white backdrop-blur-xl border border-[var(--glass-border)] rounded-2xl overflow-hidden shadow-xl max-w-4xl mx-auto">
 <div className="px-6 py-4 border-b border-[var(--glass-border)] flex items-center justify-between">
 <div>
 <h3 className="text-sm font-bold text-[var(--text-primary)] uppercase tracking-wider">
 Daftar Hasil Lomba
 ...
 <thead>
 <tr className="bg-[var(--bg-main)] border-b border-[var(--glass-border)] ">
 <th className="p-4 text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-wider whitespace-nowrap">
 Event
 </th>
 <th className="p-4 text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-wider whitespace-nowrap">
 BIB
 ...
 <th className="p-4 text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-wider whitespace-nowrap text-center">
 Rank
 </th>
 <th className="p-4 text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-wider whitespace-nowrap text-right">
 Aksi
 </th>
 </tr>
 </thead>
 ...
 <td
 colSpan={6}
 className="p-8 text-center text-[var(--text-secondary)] text-xs"
 >
 ...
 <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-[var(--glass-border)] text-sm font-bold text-slate-700 hover:bg-[var(--bg-main)] transition-colors shadow-sm">
 ...
 <th className="py-4 px-6 text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary)]">
 Nama Peserta & BIB
 </th>
 <th className="py-4 px-6 text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary)]">
 Event
 ...
 <th className="py-4 px-6 text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary)] text-center">
 Status RPC
 </th>
 <th className="py-4 px-6 text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary)] text-right">
 Aksi
 </th>
 </tr>
 </thead>
 ...
 <td className="py-4 px-6">
 <span className="px-3 py-1 rounded-full bg-[var(--bg-secondary)] border border-[var(--glass-border)] text-[10px] font-bold text-slate-600">
 {cat || "-"}
 </span>
 </td>
 ...
 {part.checkInTime && (
 <span className="text-[9px] text-[var(--text-secondary)] mt-1 font-medium">
 ...
 <span className="px-3 py-1 rounded-full bg-[var(--bg-main)] text-[var(--text-secondary)] border border-[var(--glass-border)] text-[10px] font-bold uppercase tracking-wider shadow-sm">
 Belum Diambil
 </span>
 )}
 </td>
 ...
 <td
 colSpan={5}
 className="py-12 text-center text-[var(--text-secondary)] text-sm font-medium"
 >
 ...
 {activeTab === "users" && !loading && !isSuperAdmin && (
 <div className="bg-white backdrop-blur-xl border border-[var(--glass-border)] rounded-2xl p-12 text-center shadow-xl">
 ...
 isActive
 ? "bg-red-500 text-[var(--text-primary)] shadow-lg shadow-red-500/20"
 : "bg-white border border-[var(--glass-border)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-red-500/50"
 }`}
 >
 ...
 <div className="bg-white backdrop-blur-xl border border-[var(--glass-border)] rounded-2xl overflow-hidden shadow-xl animate-in fade-in">
 <div className="px-6 py-5 border-b border-[var(--glass-border)] flex items-center gap-4">
 ...
 <div className="p-6">
 <div className="flex items-center justify-between p-4 bg-[var(--bg-main)] rounded-xl border border-[var(--glass-border)] ">
 <div>
 ...
 className="w-full bg-white border border-[var(--glass-border)] rounded-xl p-3.5 text-sm text-[var(--text-primary)] focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500/50 transition-all shadow-sm"
 >
 ...
 <div className="p-4 border border-[var(--glass-border)] rounded-xl bg-[var(--bg-main)] ">
