    ...
    <div className="min-h-screen  text-slate-900 dark:text-slate-100 py-16">
      <div className="max-w-4xl mx-auto px-4 space-y-12">
        <div className="text-center space-y-2">
          <span className="text-xs font-extrabold text-blue-600 dark:text-amber-400 uppercase tracking-widest block">HUBUNGI KAMI</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-slate-200 dark:border-gray-800 space-y-6">
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-slate-200 dark:border-gray-800">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                ...
                <button
                  type="submit"
                  className="w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2"
                >
