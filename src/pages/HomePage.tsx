...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen  text-slate-900 dark:text-slate-100 flex flex-col font-sans selection:bg-orange-500 selection:text-slate-900">
      ...
      <section className="relative pt-16 pb-28 md:pt-24 md:pb-36 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute top-1/3 right-0 w-[400px] h-[400px] bg-amber-500/15 blur-[130px] rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
          <div className="absolute -bottom-20 left-1/3 w-[350px] h-[350px] bg-orange-600/10 blur-[140px] rounded-full animate-pulse" style={{ animationDelay: '4s' }} />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto space-y-8">
            ...
            {/* Brand badge */}
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/80 dark:bg-blue-950/80 backdrop-blur-xl border border-slate-200 dark:border-slate-800 text-orange-500 dark:text-orange-400 text-xs font-bold uppercase tracking-[0.2em] shadow-xl shadow-orange-500/5 dark:shadow-orange-500/10">
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-black text-slate-900 dark:text-white tracking-tight leading-[1.05]">
              TEMUKAN EVENT<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-blue-600 to-amber-500 dark:from-blue-400 dark:via-amber-400 dark:to-orange-400">
                OLAHRAGA TERBAIKMU
              </span>
            </h1>
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/events"
                className="w-full sm:w-auto group px-8 py-4 rounded-xl bg-gradient-to-r from-orange-500 via-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 text-white font-black text-xs uppercase tracking-wider shadow-xl shadow-orange-500/25 transition-all transform hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-orange-500/30 flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-10 grid grid-cols-2 md:grid-cols-4 gap-4 text-left max-w-4xl mx-auto">
              {[
                ...
                { icon: Zap, color: 'text-amber-400', bg: 'bg-amber-500/10 border-amber-500/20', title: 'QR Check-In Instan', desc: 'Pengambilan Race Pack cepat' },
                ...
                { icon: Award, color: 'text-orange-400', bg: 'bg-orange-500/10 border-orange-500/20', title: 'Sertifikat Digital', desc: 'E-Certificate resmi hasil lomba' },
              ].map((feat, idx) => (
                <div key={idx} className={`p-4 rounded-xl bg-white dark:bg-blue-950/60 backdrop-blur-sm border ${feat.bg} hover:border-slate-300 dark:border-slate-700 transition-colors group`}>
                  ...
                  <h4 className="text-xs font-bold text-white uppercase group-hover:text-orange-400 transition-colors">{feat.title}</h4>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-slate-900 via-slate-900/95 to-slate-900 border border-slate-300 dark:border-slate-800 rounded-2xl p-6 md:p-8 backdrop-blur-xl shadow-2xl shadow-black/40">
            <div className="grid grid-cols-3 gap-6 text-center">
              {[
                { value: '500+', label: 'Event', icon: Trophy, color: 'text-orange-400' },
                { value: '50.000+', label: 'Peserta', icon: Users, color: 'text-amber-400' },
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-500 dark:text-orange-400 text-[10px] font-black uppercase tracking-widest mb-3">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-slate-900 dark:text-white uppercase tracking-tight">
                Event <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-400">Mendatang</span>
              </h2>
            </div>
            <Link
              to="/events"
              className="inline-flex items-center gap-2 text-xs font-bold text-orange-500 dark:text-orange-400 hover:text-orange-600 dark:hover:text-orange-300 uppercase tracking-wider transition-colors group"
            >
                ...
                >
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                    <div>
                      ...
                      <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors line-clamp-2">
                        {event.name}
                      </h3>
                    ...
                    <div className="pt-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
                      ...
                      <span className="inline-flex items-center gap-1.5 text-xs font-bold text-orange-400 uppercase tracking-wider group-hover:gap-2 transition-all">
                        <span>Detail</span>
        ...
        <section className="py-16 border-t border-slate-300 dark:border-slate-800/60">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h3 className="text-xl font-black text-white uppercase mb-10">
              Dipercaya Oleh <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-400">Partner Terbaik</span>
            </h3>
            <div className="flex flex-wrap items-center justify-center gap-4">
              {sponsors.map(sp => (
                <div key={sp.id} className="flex items-center gap-3 bg-white dark:bg-blue-950/60 backdrop-blur-sm px-6 py-3 rounded-xl border border-slate-300 dark:border-slate-800 hover:border-orange-500/30 transition-all hover:scale-105">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-orange-500/10 blur-[150px] rounded-full pointer-events-none" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 space-y-8">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white uppercase tracking-tight leading-tight">
            Daftar Event<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-400">Sekarang</span>
          </h2>
          ...
          <div className="pt-2 flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/register"
              className="group px-8 py-4 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 text-white font-black text-xs uppercase tracking-wider shadow-xl shadow-orange-500/25 transition-all transform hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-orange-500/30 flex items-center justify-center gap-2"
            >
