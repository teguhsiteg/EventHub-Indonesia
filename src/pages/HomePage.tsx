      ...
      <section className="relative pt-12 pb-24 md:pt-20 md:pb-32 overflow-hidden border-b border-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            {/* Ecosystem Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900/90 border border-slate-800 text-orange-400 text-xs font-bold uppercase tracking-wider shadow-xl">
            ...
            {/* Subtitle */}
            <p className="text-slate-300 text-base sm:text-lg md:text-xl leading-relaxed max-w-2xl mx-auto font-normal">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                to="/register"
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-200 font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2"
              >
              ...
              <Link
                to="/about"
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-slate-900/60 hover:bg-slate-800 border border-slate-800 text-slate-300 font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-10 grid grid-cols-2 md:grid-cols-4 gap-4 text-left max-w-4xl mx-auto">
              <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800/80">
                ...
                <h4 className="text-xs font-bold text-white uppercase">BIB System Server-Side</h4>
                <p className="text-[11px] text-slate-400">Verifikasi otomatis tanpa duplikasi</p>
              </div>
              <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800/80">
                <Zap className="w-5 h-5 text-amber-400 mb-2" />
                <h4 className="text-xs font-bold text-white uppercase">QR Check-In</h4>
                <p className="text-[11px] text-slate-400">Pengambilan Race Pack instan</p>
              </div>
              <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800/80">
                <ShieldCheck className="w-5 h-5 text-blue-400 mb-2" />
                <h4 className="text-xs font-bold text-white uppercase">Akses Peserta Aman</h4>
                <p className="text-[11px] text-slate-400">Privasi data medis & pribadi terjaga</p>
              </div>
              <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800/80">
                <Award className="w-5 h-5 text-orange-400 mb-2" />
                <h4 className="text-xs font-bold text-white uppercase">Sertifikat Digital</h4>
                <p className="text-[11px] text-slate-400">E-Certificate resmi hasil lomba</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              ...
              <h2 className="text-3xl font-black text-white uppercase tracking-tight">Event Mendatang</h2>
            </div>
            <Link
              to="/events"
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[1, 2, 3].map(i => (
                <div key={i} className="bg-slate-900 rounded-2xl h-96 animate-pulse border border-slate-800" />
              ))}
            </div>
          ) : events.length === 0 ? (
            <div className="p-12 text-center bg-slate-900/50 rounded-2xl border border-slate-800 max-w-lg mx-auto">
              <Calendar className="w-12 h-12 text-slate-600 mx-auto mb-4" />
              <h3 className="text-lg font-bold text-white">Belum ada event yang tersedia.</h3>
              <p className="text-xs text-slate-400 mt-2">Jadwal event olahraga terbaru dari penyelenggara akan segera diperbarui di Firestore.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {events.map((event) => (
                <div
                  key={event.id}
                  className="bg-slate-900 border border-slate-800 hover:border-slate-700 rounded-2xl overflow-hidden shadow-xl transition-all duration-300 flex flex-col group hover:-translate-y-1"
                >
                  {/* Banner image */}
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                    ...
                    <div className="pt-4 border-t border-slate-800/80 space-y-3">
                      ...
                      <Link
                        ...
                        className="w-full py-3 rounded-xl bg-slate-800 group-hover:bg-orange-600 text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2"
                      >
        ...
        <section className="py-16 bg-slate-950 border-b border-slate-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8">
              {sponsors.map(sp => (
                <div key={sp.id} className="flex items-center gap-3 bg-slate-900/60 px-6 py-3 rounded-xl border border-slate-800">
                  <span className="text-xs font-bold text-slate-300 uppercase">{sp.name}</span>
                </div>
              ))}
            </div>
          </div>
