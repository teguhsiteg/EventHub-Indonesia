    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-black text-white uppercase tracking-tight">Masuk Akun Peserta</h2>
          <p className="text-xs text-slate-400">Akses pendaftaran, nomor BIB, QR Code, dan sertifikat finisher Anda.</p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4 text-xs">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="block text-slate-300 font-bold uppercase">Kata Sandi</label>
              <button
                type="button"
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-200 text-xs font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-3"
        >
