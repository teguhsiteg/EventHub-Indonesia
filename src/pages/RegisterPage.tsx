        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="fullName" className="block text-xs font-medium text-slate-600 dark:text-slate-500 dark:text-slate-400">
                Nama Lengkap
              </label>
            ...
            {/* Nomor WhatsApp */}
            <div className="space-y-1.5">
              <label htmlFor="whatsapp" className="block text-xs font-medium text-slate-600 dark:text-slate-500 dark:text-slate-400">
                Nomor WhatsApp
              </label>
              <div className="relative">
