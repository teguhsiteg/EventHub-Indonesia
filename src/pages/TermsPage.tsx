...
export const TermsPage: React.FC = () => {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-red-950/90 border border-[var(--glass-border)] text-red-500 dark:text-red-400 text-xs font-bold uppercase tracking-wider shadow-xl mb-6">
 ...
 <div className="bg-white/60 dark:bg-red-950/50 border border-[var(--glass-border)] rounded-3xl p-8 md:p-12 shadow-xl prose dark:prose-invert max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:text-[var(--text-primary)] dark:prose-headings:text-white prose-headings:tracking-tight prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-6 prose-h3:text-lg prose-h3:mt-8 prose-p:text-slate-600 dark:prose-p:text-slate-700 dark:text-slate-600 prose-p:leading-relaxed prose-a:text-red-500 dark:prose-a:text-red-400 prose-a:no-underline hover:prose-a:text-red-600 dark:hover:prose-a:text-red-300 prose-strong:text-[var(--text-primary)] dark:prose-strong:text-white prose-code:text-red-500 dark:prose-code:text-red-300 prose-code:bg-[var(--bg-secondary)] dark:prose-code:bg-[var(--bg-secondary)] dark:bg-[var(--bg-secondary)] prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-li:text-slate-600 dark:prose-li:text-slate-700 dark:text-slate-600 prose-hr:border-[var(--glass-border)] dark:prose-hr:border-[var(--glass-border)] prose-blockquote:border-red-500 prose-blockquote:text-[var(--text-secondary)] dark:prose-blockquote:text-slate-600 dark:text-[var(--text-secondary)] dark:text-[var(--text-secondary)] prose-blockquote:bg-red-50 dark:prose-blockquote:bg-[var(--bg-secondary)] dark:bg-[var(--bg-secondary)]/50 prose-blockquote:py-2 prose-blockquote:px-6 prose-blockquote:rounded-2xl prose-ol:list-decimal prose-ol:pl-6 prose-ul:list-disc prose-ul:pl-6 prose-li:my-1 prose-headings:flex prose-headings:items-center prose-headings:gap-2 backdrop-blur-md">
