      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-md w-full p-8 shadow-2xl text-center">
        ...
        {loading ? (
          <div className="py-12 space-y-4">
            ...
            <p className="text-xs text-slate-400 font-medium">Memverifikasi Token QR Code...</p>
          </div>
        ) : valid && participant ? (
          <div className="space-y-6">
            ...
            <div>
              ...
              <h2 className="text-2xl font-black text-white uppercase mt-3">
                {participant.fullName}
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">BIB Nomor: <strong className="text-amber-400 font-mono text-sm">{participant.bibNumber}</strong></p>
            </div>
            ...
            <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800/80 text-left space-y-2 text-xs">
              ...
              <div className="flex justify-between py-1 border-b border-slate-800">
                ...
                <span className="font-bold text-white">{participant.jerseySize}</span>
              </div>
              <div className="flex justify-between py-1">
                <span className="text-slate-400">Nomor Registrasi:</span>
                <span className="font-mono text-slate-300">REG-VERIFIED</span>
              </div>
            </div>
            ...
            <Link
              to="/"
              className="block w-full py-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs uppercase tracking-wider"
            >
              Kembali ke Beranda
            </Link>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <h2 className="text-xl font-bold text-white mt-3">Verifikasi Gagal</h2>
