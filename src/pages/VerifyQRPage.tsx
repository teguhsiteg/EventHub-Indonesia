        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className=" p-4 rounded-2xl border border-slate-200 dark:border-slate-800/80 text-left space-y-2 text-xs">
              ...
              <div className="flex justify-between py-1 border-b border-slate-200 dark:border-slate-800">
                <span className="text-slate-500 dark:text-slate-500 dark:text-slate-400">Ukuran Jersey:</span>
                <span className="font-bold text-slate-900 dark:text-white">{participant.jerseySize}</span>
              </div>
              <div className="flex justify-between py-1">
                <span className="text-slate-500 dark:text-slate-500 dark:text-slate-400">Nomor Registrasi:</span>
                <span className="font-mono text-slate-600 dark:text-slate-600 dark:text-slate-300">REG-VERIFIED</span>
              </div>
            </div>

            <p className="text-[11px] text-slate-500 dark:text-slate-500 dark:text-slate-400 leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">
