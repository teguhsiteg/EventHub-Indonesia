...
export const RpcDashboardPage: React.FC = () => {
 ...
 className="w-full pl-11 pr-4 py-3 bg-white/50 backdrop-blur-sm border border-[var(--glass-border)] rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all font-mono text-sm shadow-inner"
 />
 </div>
 <button
 type="submit"
 ...
 className="w-full py-4 flex flex-col items-center justify-center gap-3 bg-slate-50 hover:bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-2xl transition-colors text-slate-600"
 >
 ...
 <span className="text-xs font-bold px-3 py-1 bg-[var(--bg-secondary)] text-slate-600 rounded-full">{scanHistory.length} scan terakhir</span>
 </div>
 ...
 <th className="py-4 px-6 text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary)]">Waktu Scan</th>
 <th className="py-4 px-6 text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary)]">Nama Peserta</th>
 <th className="py-4 px-6 text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary)]">BIB</th>
 <th className="py-4 px-6 text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary)] text-right">Aksi</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-slate-100">
 {scanHistory.map(history => (
 <tr key={history.id} className="hover:bg-[var(--bg-primary)]/50 transition-colors">
 ...
 <td className="py-4 px-6">
 <p className="text-sm font-bold text-[var(--text-primary)]">{history.fullName}</p>
 <p className="text-[10px] text-[var(--text-secondary)] mt-0.5">{history.email}</p>
 </td>
 <td className="py-4 px-6">
 <span className="px-3 py-1 rounded-full bg-red-50 border border-red-100 text-[10px] font-black text-red-600">
 ...
 <tr>
 <td colSpan={4} className="py-12 text-center text-[var(--text-secondary)] text-sm font-medium">
 ...
 {/* Confirmation Modal */}
 {showConfirmModal && (
 <div className="fixed inset-0 bg-[var(--bg-primary)]/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
 ...
 <h3 className="text-xl font-black text-[var(--text-primary)] mb-2">Konfirmasi RPC</h3>
 {scannedParticipantCache ? (
 <p className="text-sm text-slate-700 mb-6">
 Peserta: <strong className="text-red-600 text-base">{scannedParticipantCache.fullName}</strong><br/>
 <span className="text-[var(--text-secondary)] text-xs">{scannedParticipantCache.email}</span>
 </p>
 ) : (
 <p className="text-sm text-[var(--text-secondary)] mb-6">Pastikan identitas peserta sesuai.</p>
 )}
 ...
 className="w-full px-4 py-3 bg-slate-50 border border-[var(--glass-border)] rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all font-mono font-bold"
 />
 </div>
 </div>
 ...
 className="flex-1 px-4 py-3 text-sm font-bold text-slate-600 bg-[var(--bg-secondary)] hover:bg-slate-200 rounded-xl transition-colors"
 >
 Batal
 </button>
 <button
